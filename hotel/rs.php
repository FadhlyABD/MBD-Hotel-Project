    ...
    <div class="custom-margin py-2 text-left">
        <ul class="navbar-nav d-flex list-group list-group-horizontal-sm">
            ...
            <li class="nav-item"><a href="rooms.php" class="nav-link s-font fw-medium text-color2 md-text">&nbsp;Rooms &
                    Suites ></a></li>
            <li class="nav-item"><a href="#" class="nav-link s-font fw-medium md-text">&nbsp;Residence Suite</a></li>
        </ul>
    </div>
    <!-- navigator end -->
        ...
        <div class="swiper swiper-container-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="\hotel\images\roomdetail\residencesuitedetail.svg" class="w-100 d-block img-fluid">
                </div>
                <div class="swiper-slide">
    ...
    <div class="custom-margin margintop-20 mb-5">
        <div class="row">
            <div class="col" style="width: 34.75rem">
                ...
                <h2 class="mt-2 h-font">Residence Suite</h2>
                <h6 class="mt-3 h-font fw-normal bigger-text">Modern comfort and privileges.</h6>
                <h6 class="mt-3 md-text">The fully furnished Residence Suites, located on the 3th and 4th floors,
                    have high ceilings that enhance the overall elegance. They are ideal for single occupants or a
                    family of four, with spacious living, dining and study areas.</h6>
                ...
                <ul class="md-text p-0">
                    <li class="">• 119 sqm / 1,281 sqf of luxury.</li>
                    <li class="">• Expansive views of Surabaya.</li>
                    <li class="">• 1-bedroom suite.</li>
                    <li class="">• Living, dining and study room.</li>
                    <li class="">• A kitchenette.</li>
                    <li class="">• Horizon Club Lounge access.</li>
                    <li class="">• Roomy bathroom with bathtub.</li>
                    <li class="">• Double wash basins.</li>
                </ul>
                <h6 class="mt-3 h-font fw-bold">Amenities</h6>
                <ul class="mt-3 md-text p-0">
                    <h6 class="md-text fw-bold p-0">Bath & Personal Care</h6>
                    <li class="">• Loccitane toiletries</li>
                </ul>
                <ul class="mt-3 md-text p-0">
                ...
                <ul class="mt-3 md-text p-0">
                    ...
                    <li class="">• Study room comple with office stationaries</li>
                    <li class="">• Full-size executive writing desk</li>
                </ul>
                <ul class="mt-3 md-text p-0">
                    <h6 class="md-text fw-bold p-0">Refreshments</h6>
                    <li class="">• Refreshment at Horizon Club Lounge</li>
                </ul>
