    ...
    <div class="custom-margin py-2 text-left">
        <ul class="navbar-nav d-flex list-group list-group-horizontal-sm">
            ...
            <li class="nav-item"><a href="rooms.php" class="nav-link s-font fw-medium text-color2 md-text">&nbsp;Rooms &
                    Suites ></a></li>
            <li class="nav-item"><a href="#" class="nav-link s-font fw-medium md-text">&nbsp;Horizon Club Executive
                    Room</a></li>
        </ul>
    </div>
    <!-- navigator end -->
    ...
    <div class="custom-margin margintop-20 mb-5">
        <div class="row">
            <div class="col" style="width: 34.75rem">
                ...
                <h2 class="mt-2 h-font">Horizon Club Executive Room</h2>
                <h6 class="mt-3 h-font fw-normal bigger-text">Stylish interiors and outstanding views.</h6>
                <h6 class="mt-3 md-text">Horizon Club Executive Rooms are defined by abundant space and fine amenities.
                    These rooms are an excellent choice for the traveller who craves more personalised attention and
                    services.</h6>
                ...
                <ul class="md-text p-0">
                    <li class="">• 49 sqm / 527 sqf of luxury..</li>
                ...
                <ul class="mt-3 md-text p-0">
                    ...
                    <li class="">• Separate shower and bath</li>
