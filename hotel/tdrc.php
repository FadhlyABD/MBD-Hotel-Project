    ...
    <div class="custom-margin py-2 text-left">
        <ul class="navbar-nav d-flex list-group list-group-horizontal-sm">
            ...
            <li class="nav-item"><a href="rooms.php" class="nav-link s-font fw-medium text-color2 md-text">&nbsp;Rooms &
                    Suites ></a></li>
            <li class="nav-item"><a href="#" class="nav-link s-font fw-medium md-text">&nbsp;Two Deluxe Room
                    Connecting</a></li>
        </ul>
    </div>
    <!-- navigator end -->
        ...
        <div class="swiper swiper-container-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="\hotel\images\roomdetail\tworoomconnectsdetail.svg" class="w-100 d-block img-fluid">
                </div>
                <div class="swiper-slide">
                    <img src="\hotel\images\roomdetail\tworoomconnectsdetail2.svg" class="w-100 d-block img-fluid">
                </div>
            </div>
    ...
    <div class="custom-margin margintop-20 mb-5">
        <div class="row">
            <div class="col" style="width: 34.75rem">
                ...
                <h2 class="mt-2 h-font">Two Deluxe Room Connecting</h2>
                <h6 class="mt-3 h-font fw-normal bigger-text">Connecting rooms with chic interiors and panoramic city
                    views.</h6>
                <h6 class="mt-3 md-text">Comfort and elegance define the Deluxe Rooms, which offer contemporary luxury
                    in light tones evoking classic Javanese design elements. This room type is connecting between Deluxe
                    King and Deluxe Twin room.</h6>
                ...
                <ul class="md-text p-0">
                    <li class="">• Each room offers 70 sqm / 752 sqf of luxury.</li>
                    <li class="">• This room type includes 2 rooms which are inter-connecting. These rooms feature a Deluxe King room connecting with a Deluxe Twin room.</li>
                    <li class="">• Panoramic city views.</li>
                    <li class="">• Maximum occupancy : 5 adults and 2 children</li>
