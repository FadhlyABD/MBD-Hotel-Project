    ...
    <div class="custom-margin py-2 text-left">
        <ul class="navbar-nav d-flex list-group list-group-horizontal-sm">
            ...
            <li class="nav-item"><a href="rooms.php" class="nav-link s-font fw-medium text-color2 md-text">&nbsp;Rooms &
                    Suites ></a></li>
            <li class="nav-item"><a href="#" class="nav-link s-font fw-medium md-text">&nbsp;Executive Suite</a></li>
        </ul>
    </div>
    <!-- navigator end -->
        ...
        <div class="swiper swiper-container-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="\hotel\images\roomdetail\executivesuitedetail.svg" class="w-100 d-block img-fluid">
                </div>
                <div class="swiper-slide">
    ...
    <div class="custom-margin margintop-20 mb-5">
        <div class="row">
            <div class="col" style="width: 34.75rem">
                ...
                <h2 class="mt-2 h-font">Executive Suite</h2>
                <h6 class="mt-3 h-font fw-normal bigger-text">Luxury living with magnificent views.</h6>
                <h6 class="mt-3 md-text">A flawless space to work or relax in, our Executive Suites combine Surabaya's sophisticated rooms with excellent Rendezvous service.</h6>
                ...
                <ul class="mt-3 md-text p-0">
                    ...
                    <li class="">• Shangri-La toiletries</li>
                ...
                <ul class="mt-3 md-text p-0">
                    ...
                    <li class="">• DVD home theatre entertainment system</li>
                </ul>
                <ul class="mt-3 md-text p-0">
