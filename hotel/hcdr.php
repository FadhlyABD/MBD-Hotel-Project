    ...
    <div class="custom-margin py-2 text-left">
        <ul class="navbar-nav d-flex list-group list-group-horizontal-sm">
            ...
            <li class="nav-item"><a href="rooms.php" class="nav-link s-font fw-medium text-color2 md-text">&nbsp;Rooms &
                    Suites ></a></li>
            <li class="nav-item"><a href="#" class="nav-link s-font fw-medium md-text">&nbsp;Horizon Club Deluxe
                    Room</a></li>
        </ul>
    </div>
    <!-- navigator end -->
        ...
        <div class="swiper swiper-container-1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="\hotel\images\roomdetail\deluxdetail.svg" class="w-100 d-block img-fluid">
                </div>
                <div class="swiper-slide">
                    <img src="\hotel\images\roomdetail\deluxdetail2.svg" class="w-100 d-block img-fluid">
                </div>
            </div>
    ...
    <div class="custom-margin margintop-20 mb-5">
        <div class="row">
            <div class="col" style="width: 34.75rem">
                ...
                <h2 class="mt-2 h-font">Horizon Club Deluxe Room</h2>
                <h6 class="mt-3 h-font fw-normal bigger-text">Contemporary décor with outstanding views.</h6>
                <h6 class="mt-3 md-text">Horizon Club Deluxe Rooms feature contemporary design with rich earth tones and
                    ample space to work or relax. Guests enjoy the additional privilege of exclusive Horizon Club
                    benefits and personalised services.</h6>
                ...
                <ul class="md-text p-0">
                    <li class="">• 35 sqm / 376 sqf of luxury.</li>
                ...
                <ul class="mt-3 md-text p-0">
                    ...
                    <li class="">• Spacious Bathroom with bidet</li>
                    <li class="">• Signature bed linen</li>
                    <li class="">• Hair dryer</li>
                </ul>
                <ul class="mt-3 md-text p-0">
                    <h6 class="md-text fw-bold p-0">Media & Entertainment</h6>
                    <li class="">• Wi-Fi access (fixed LAN and Wi-Fi)</li>
                    <li class="">• Flatscreen satellite television & radio</li>
                    <li class="">• Universal electric plug</li>
                    <li class="">• DVD entertainment system</li>
                </ul>
                <ul class="mt-3 md-text p-0">
                    <h6 class="md-text fw-bold p-0">Office Equipment & Stationery</h6>
                    <li class="">• Full size executive writing desk</li>
                    <li class="">• International Direct Dial telephone</li>
                    <li class="">• Independent fax line</li>
